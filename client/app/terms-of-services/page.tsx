...
const TermsOfServices = () => {
  return (
    <div className="w-full px-3 py-3 ">
      <div className="text-purple-800 py-5 px-10 bg-white min-h-[90vh] max-h-[fit-content] rounded-md">
        ...
        <p>
          All the information on this website - www.prepaim.com - is published
          in good faith and for general information purpose only. prepaim does
          ...
          you find on this website (prepaim), is strictly at your own risk.
          prepaim will not be liable for any losses and/or damages in connection
        ...
        <p>
          ...
          as well as their &apos;&apos;Terms of Service&apos;&apos; before
