    ...
    <>
      {items.map((item: any) => {
        return (
          <div
            key={item}
            className="w-full px-2 py-2 gap-1 cursor-pointer flex justify-between items-center hover:text-purple-900 border border-b-1 border-t-0 border-l-0 border-r-0"
          >
