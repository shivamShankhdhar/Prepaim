...
const ToggleAnswerExplanationBtn = ({
  ...
  return (
    <Button
      className="bg-purple-100 focus:ring-2 focus:outline-none focus:ring-purple-300 min-w-[fit-content] flex-1 h-9 border rounded-sm hover:bg-purple-200 flex items-center justify-center gap-2 px-2 py-0 cursor-pointer text-purple-900 border-purple-300 "
