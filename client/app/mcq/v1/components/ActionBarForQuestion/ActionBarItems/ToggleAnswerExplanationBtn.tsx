...
const ToggleAnswerExplanationBtn = ({
  ...
  return (
    ...
    >
      <Button
        className="bg-purple-200 hover:bg-purple-300 w-[fit-content] border rounded-md flex items-center justify-center gap-2 px-4 py-1 cursor-pointer text-purple-800"
        onClick={() => {
          if (isAnswerLocked) {
            toast.error(
              "Answer explanation is locked right now, please click right option to unlock answer explanation."
