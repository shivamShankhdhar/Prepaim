  ...
  return (
    <>
      {index === 0 && item.level === "a" && (
        <div className="flex w-full px-2 rounded-[5px] font-[13px] justify-center items-center bg-indigo-400 border border-indigo-900 mb-2 text-indigo-50 mt-0">
          BASIC
        </div>
      )}
      {index === medium && item.level === "b" && (
        <div className="flex w-full px-2 rounded-[5px]  font-[13px] justify-center items-center bg-yellow-500 border border-[#F49D1A] text-indigo-50 mb-2 mt-2">
          MEDIUM
        </div>
      )}
