...
const Sidebar = ({ error, requestedPage, loading }: Props) => {
  ...
  return (
    ...
    >
      <div className="px-2 py-[10px] text-center border border-dashed border-t-0 border-b-1 border-l-0 border-r-0 border-purple-900 flex justify-center items-center font-semibold text-purple-900 ">
