...
const SidebarItem = ({
  ...
  return (
    <div
      className={`flex border flex-row border-dashed justify-start border-purple-800 border-t-0 border-l-0 ${
        ...
        String(item.name.replaceAll(" ", "-")) === chapter
          ? " bg-purple-800 border-l-1 border-l-white text-white hover:bg-purple-900 "
