            ...
            return (
              <>
                <div
                  ...
                  className="sm:w-full max-sm:w-full md:w-full max-md:w-full lg:w-[49%] 2xl:w-[49%] xl:w-[49%] flex flex-col bg-white rounded-md border py-2 px-5 shadow-md"
                >
                  {/* question level  */}
                  <div className="w-full mt-2 h-5 flex justify-end items-center">
                    <QuestionLevel level={question?.level} isText={true} />
                  </div>
                  {/* question heading  */}
                  ...
                  <div className="flex w-full px-2 justify-start items-start gap-2 flex-col mb-5">
                    ...
                    {clickedId === question._id ? (
                      <div
                        className="bg-purple-200 flex gap-1 border border-purple-400 cursor-pointer w-[fit-content] justify-start items-center px-3 py-1 text-purple-900 rounded-md"
                        onClick={() => {
                          setClickedId("");
                        }}
                      >
