              ...
              >
                ...
                {cookies.get("isQuestionGuideClosed") !== "true" && (
                  <div className="bg-purple-100 border border-purple-300 text-purple-900 rounded-sm flex justify-between items-center gap-2 px-5 py-1 text-[0.8rem] hover:cursor-pointer animate-pulse hover:animate-none">
                    ...
                    <LightTooltip title="Close">
                      <div
                        // title="Close"
                        className="flex cursor-pointer justify-center items-center h-4 w-4 rounded-full bg-purple-900 text-white"
                        onClick={() =>
                ...
                <div
                  className={`flex ${
                    ...
                    "border border-dashed border-b-1 border-purple-900 border-t-1 border-r-0 border-l-0"
                  ...
                  <div className="flex flex-col gap-1">
                    <div className="flex w-full justify-between py-2 ">
                      ...
                      <Button
                        ...
                        className=" bg-purple-800 focus:ring-2 flex justify-center items-center focus:outline-none focus:ring-purple-200 hover:bg-purple-900 text-white disabled:text-white disabled:bg-purple-50 gap-1 disabled:cursor-not-allowed py-1"
