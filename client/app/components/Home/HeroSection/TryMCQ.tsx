...
const TryMCQ = ({ subjects, loading }: any) => {
  ...
  return (
    <>
      <div className="w-full  text-gray-700 border border-dashed border-b-1 border-t-0 border-l-0 border-r-0 border-purple-900 py-2 flex justify-center items-center font-semibold text-2xl">
        Try MCQ&apos;s
      </div>
      ...
      {subjects.length > 4 && (
        <div className="w-full flex justify-center py-5 itms-center">
          <Button
            ...
            className="px-4 py-1 bg-purple-900 hover:bg-purple-900 text-white shadow-xl"
          >
            View all Subjects
          </Button>
        </div>
