...
const HeroSection = () => {
  return (
    <>
      <div className="w-full bg-gradient-to-r  text-wrap from-indigo-900  to-indigo-900 text-white flex justify-center items-center text-center flex-col py-10">
        ...
        <div className="w-full flex flex-wrap justify-center items-center pb-11 gap-2 py-5">
          <Button
            ...
            className="flex justify-center focus:ring-3 focus:outline-none focus:ring-white border border-white items-center bg-white text-indigo-900 px-5 text-sm cursor-pointer rounded-sm py-2 hover:bg-indigo-900 hover:text-white"
          >
            Try MCQ Questions
          </Button>
          ...
          {/* <Button
            href="#trycoding"
            sx={{ border: 1 }}
            className="flex justify-center items-center border hover:bg-white hover:text-indigo-900 border-white text-white px-5 text-sm cursor-pointer rounded-sm py-2"
          >
