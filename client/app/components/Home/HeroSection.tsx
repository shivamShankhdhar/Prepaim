      ...
      <div className="w-full bg-gradient-to-r  text-wrap from-purple-800 via-purple-600 to-purple-800 px-11 text-white flex justify-center items-center text-center flex-col py-10">
        ...
        <div className="w-full flex flex-wrap justify-center items-center pb-11 gap-2 py-5">
          <Button
            ...
            className="flex justify-center focus:ring-4 focus:outline-none focus:ring-white-300 border border-white items-center bg-white text-purple-700 px-5 text-sm cursor-pointer rounded-sm py-2 hover:bg-purple-700 hover:text-white"
          >
            Try MCQ Questions
          </Button>
