...
const ShareBtn = () => {
  ...
  return (
    <Button
      className={`min-w-[fit-content] focus:ring-2 focus:outline-none focus:ring-purple-300 flex-1 rounded-sm px-2 flex gap-2 py-0 justify-center cursor-pointer items-center border  ${
        linkCopied
