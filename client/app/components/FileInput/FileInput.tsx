        ...
        <div>
          {imageFile !== null && (
            <div
              ...
              className="px-3 py-1 cursor-pointer bg-purple-800 hover:bg-purple-900 disabled:bg-purple-200 text-white rounded-md flex justify-center items-center gap-1"
            >
